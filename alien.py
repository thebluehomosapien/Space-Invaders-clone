...
class Alien(Sprite):
    alien_images0 = [pg.transform.rotozoom(pg.image.load(f'images/alien10{n}.png'), 0, 0.7) for n in range(2)]
    alien_images1 = [pg.transform.rotozoom(pg.image.load(f'images/alien20{n}.png'), 0, 0.7) for n in range(7)]
    alien_images2 = [pg.transform.rotozoom(pg.image.load(f'images/alien30{n}.png'), 0, 0.7) for n in range(3)]
    alien_images3 = [pg.transform.rotozoom(pg.image.load(f'images/alien40{n}.png'), 0, 0.7) for n in range(3)]
